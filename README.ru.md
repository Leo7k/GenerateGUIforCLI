...
2. Нажмите **"Choose a file with a declarative description of CLI arguments"** и выберите ваш JSON-файл с описанием GUI.
3. Приложение автоматически сгенерирует поля ввода на основе выбранного файла.

### Шаг 3: Генерация и выполнение
1. Заполните поля в графическом интерфейсе.
2. Нажмите **"Generate CLI arguments"** для предпросмотра CLI-команды.
